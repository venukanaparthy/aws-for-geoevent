...
public class AwsIoTHubInboundTransportDefinition extends TransportDefinitionBase
{
  // logger
  private static final BundleLogger LOGGER                                      = BundleLoggerFactory.getLogger(AwsIoTHubInboundTransportDefinition.class);
  ...
  public AwsIoTHubInboundTransportDefinition()
  {
  ...
  {
    return "${com.esri.geoevent.transport.aws-transport.TRANSPORT_IN_LABEL}";
  }
  ...
  {
    return "${com.esri.geoevent.transport.aws-transport.TRANSPORT_IN_DESC}";
  }
}
